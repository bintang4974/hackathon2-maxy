  ...
  <body>
    <div class="wireframe-landing-page">
      ...
      <header class="header-background-parent">
        ...
        <a href="frontend/src/about-us.html" class="nav-link about-us">About Us</a>
        <a href="frontend/src/impact-trips.html" class="nav-link impact-trips">Impact Trips</a>
        <a href="frontend/src/register.html" class="nav-link register">register</a>
      </header>
      ...
      <main class="wireframe-landing-page-inner">
        <div class="frame-parent">
          ...
          <div class="frame-wrapper6">
            <div class="help-image-parent">
              <img
                class="help-image-icon"
                loading="lazy"
                alt=""
                src="{{ asset('frontend/public/image 54.png')}}"
              />

              <div class="how-can-we-help-you-parent">
                <h1 class="how-can-we">How Can We Help You?</h1>
                <div class="button-group">
                  <button class="button3">
                    <div class="button4">
                        <a href="frontend/src/invesment.html">
                            <b class="read-more3">Investment</b>
                        </a>    
                    </div>
                  </button>
                  <button class="button5">
                    <div class="button6">
                        <a href="frontend/src/advisor.html">
                            <b class="read-more4">Advisory</b>
                        </a>
                    </div>
                  </button>
                </div>
          ...
          <div class="frame-wrapper7">
            <div class="frame-parent9">
              <div class="collaboration-for-a-sustainabl-wrapper">
                <h1 class="collaboration-for-a">
              ...
              <img
                    class="content-block-icon1"
                    loading="lazy"
                    alt=""
                    src="{{ asset('frontend/public/image 52.png')}}"
                />
            </div>
          </div>
          <div class="frame-wrapper8">
            <div class="frame-parent10">
              <div class="frame-parent11">
                ...
                <div class="mingcuteyoutubefill-icon">
                  <div class="mingcutemailfill-icon">
                    <img
                      class="mingcutemailfill-icon-child"
                      loading="lazy"
                      alt=""
                      src="{{ asset('frontend/public/image 46.png')}}"
                    />
                  </div>
                  <div class="mingcuteyoutubefill-icon-inner">
                    <img
                      class="frame-child"
                      loading="lazy"
                      alt=""
                  ...
                  <div class="mingcutemailfill-icon1">
                    <img
                      class="mingcutemailfill-icon-item"
                      loading="lazy"
                      alt=""
                      src="{{ asset('frontend/public/image 46.png')}}"
                    />
              ...
              <div class="button-read-more">
                <button class="button7">
                    <a href="frontend/src/lastevent.html">
                        <b class="read-more5">View All Events</b>
                    </a>
                </button>  
              </div>
          ...
          <div class="social-icon-wrapper">
            <iframe width="100%" height="315" src="{{ asset('frontend/public/TBN Indonesia Profile.mp4')}}" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>
      </main>
